...
from language_model.TextCNN import Model
...
def main():
    ...
    print('模型结构:')
    print(textcnn)
    parameters_num = get_parameter_number(textcnn)
    ...
    optimizer = optim.Adam(textcnn.parameters(),
                           lr=lr_,
    ...
    time5 = time.time()
    train_model(textcnn, train_iter, train_price_iter, optimizer, criterion,
    ...
    print('begin tesing...')
    time7 = time.time()
    test_model(textcnn, os.path.join(model_path, model_name + '.pt'),
