...
from dgl_model.MyOwnModel import Graph_model
...
def main():
    ...
    print('define model...')
    Graph_my = Graph_model(graph_type=graph_type,
                           n_vocab=n_vocab,
    ...
    print('模型结构:')
    print(Graph_my)
    parameters_num = get_parameter_number(Graph_my)
    ...
    optimizer = optim.Adam(Graph_my.parameters(),
                           lr=lr_,
    ...
    time5 = time.time()
    train_model(Graph_my, train_iter, train_price_iter, optimizer, criterion,
    ...
    print('begin tesing...')
    time7 = time.time()
    test_model(Graph_my, os.path.join(model_path, model_name + '.pt'),
